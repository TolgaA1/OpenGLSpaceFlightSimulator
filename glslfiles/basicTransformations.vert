...
void main(void)
{
	...
	ex_LightDir = vec3(ViewMatrix *LightPos2);
	ex_LightPos = vec3(0,0,-600);//ViewMatrix * LightPos);

	ex_SpotLightDir = vec3(0,0,1);//ViewMatrix * LightDir);
}